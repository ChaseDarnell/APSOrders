...
To build the final jar and optimize the APSOrders application for production, run:
...
Then navigate to [http://localhost:4567](http://localhost:4567) in your browser.
