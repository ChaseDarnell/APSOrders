...
import com.apsorders.orders.repository.PieceRepository;
...
class PieceResourceIT {
    ...
    private static final StatusP DEFAULT_STATUS_P = StatusP.TBR;
    private static final StatusP UPDATED_STATUS_P = StatusP.HOLDREFURB;
    ...
    void createPiece() throws Exception {
        ...
        assertThat(testPiece.getNotes()).isEqualTo(DEFAULT_NOTES);
        assertThat(testPiece.getStatusP()).isEqualTo(DEFAULT_STATUS_P);
    }
    ...
    void getAllPieces() throws Exception {
        ...
        restPieceMockMvc
            ...
            .andExpect(jsonPath("$.[*].statusP").value(hasItem(DEFAULT_STATUS_P.toString())));
    }
    ...
    void getPiece() throws Exception {
        ...
        restPieceMockMvc
            ...
            .andExpect(jsonPath("$.statusP").value(DEFAULT_STATUS_P.toString()));
    }
    ...
    void putNewPiece() throws Exception {
        ...
        assertThat(testPiece.getNotes()).isEqualTo(UPDATED_NOTES);
        assertThat(testPiece.getStatusP()).isEqualTo(UPDATED_STATUS_P);
    }
    ...
    void partialUpdatePieceWithPatch() throws Exception {
        ...
        partialUpdatedPiece.model(UPDATED_MODEL).desc(UPDATED_DESC).notes(UPDATED_NOTES);
