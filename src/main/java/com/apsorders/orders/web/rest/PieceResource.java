...
import com.apsorders.orders.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.apsorders.orders.domain.Piece}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Piece> result = pieceRepository
            ...
            .map(existingPiece -> {
                ...
                if (piece.getNotes() != null) {
                    existingPiece.setNotes(piece.getNotes());
                }
                if (piece.getStatusP() != null) {
                    existingPiece.setStatusP(piece.getStatusP());
                }
